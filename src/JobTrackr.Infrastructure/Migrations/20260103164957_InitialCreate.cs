        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobApplicationStatusId = table.Column<Guid>(type: "TEXT", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_Position",
                table: "JobApplications",
                column: "Position");

            migrationBuilder.CreateIndex(
                name: "IX_JobApplicationStatuses_DisplayOrder",
                table: "JobApplicationStatuses",
                column: "DisplayOrder");

            migrationBuilder.CreateIndex(
                name: "IX_JobApplicationStatuses_Name",
                table: "JobApplicationStatuses",
                column: "Name",
                unique: true);
